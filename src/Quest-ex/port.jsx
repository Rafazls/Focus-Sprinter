...
{/*Primeira Questão*/}
       <div className=''>
            <h1 className=' text-lg mb-4 ml-8 '>   1. Identifique a opção em que o verbo está corretamente conjugado de acordo com a concordância verbal:</h1>
            <div className="form-control  mb-4 ml-8 ">
              <label className="label cursor-pointer">
                <input type="radio" name="radio-10" className="radio checked:bg-blue-500 mr-2" />
                <span className="label-text ml-3">Os meninos estuda para as provas.</span>
              </label>
            </div>
            <div className="form-control  mb-4 ml-8 ">
              <label className="label cursor-pointer">
                <input type="radio" name="radio-10" className="radio checked:bg-blue-500 mr-2" />
                <span className="label-text ml-3">    A turma comemorou o resultado da competição.</span>
              </label>
            </div>
            <div className="form-control  mb-4 ml-8 ">
              <label className="label cursor-pointer">
                <input type="radio" name="radio-10" className="radio checked:bg-blue-500 mr-2" />
                <span className="label-text ml-3">    O cachorro latiu para os correios.</span>
              </label>
            </div>
          </div>
          ...
          {/*Segunda Questão*/}
          <div className=''>
            <h1 className='text-lg mb-4 ml-8'>   2. Indique a alternativa correta em relação à regência do verbo "assistir":
            </h1>
            <div className="form-control mb-4 ml-8">
              <label className="label cursor-pointer">
                <input type="radio" name="radio-20" className="radio checked:bg-blue-500 mr-2" />
                <span className="label-text ml-3">    Eu assisti [o, a] palestra ontem.</span>
              </label>
            </div>
            <div className="form-control mb-4 ml-8">
              <label className="label cursor-pointer">
                <input type="radio" name="radio-20" className="radio checked:bg-blue-500 mr-2" />
                <span className="label-text ml-3">    Ela assistiu [o, a] apresentação de dança com interesse.</span>
              </label>
            </div>
            <div className="form-control mb-4 ml-8">
              <label className="label cursor-pointer">
                <input type="radio" name="radio-20" className="radio checked:bg-blue-500 mr-2" />
                <span className="label-text ml-3">    Nós assistimos [o, a] filme no cinema.</span>
              </label>
            </div>
          </div>
          ...
          {/*Terceira Questão*/}
          <div className=''>
            <h1 className='text-lg mb-4 ml-8'>   3.Indique a alternativa correta em relação ao uso das letras "s" e "ss":</h1>
            <div className="form-control mb-4 ml-8">
              <label className="label cursor-pointer">
                <input type="radio" name="radio-30" className="radio checked:bg-blue-500 mr-2" />
                <span className="label-text ml-3">    Ela preten[de, sse] viajar nas férias.</span>
              </label>
            </div>
            <div className="form-control mb-4 ml-8">
              <label className="label cursor-pointer">
                <input type="radio" name="radio-30" className="radio checked:bg-blue-500 mr-2" />
                <span className="label-text ml-3">    Eu [assi]sti um filme interessante ontem.</span>
              </label>
            </div>
            <div className="form-control mb-1 ml-8">
              <label className="label cursor-pointer">
                <input type="radio" name="radio-30" className="radio checked:bg-blue-500  mr-2" />
                <span className="label-text ml-3">    A [exse]cussão sobre o tema foi acalorada.s</span>
              </label>
            </div>
          </div>
